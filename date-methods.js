...
console.log(`The time is: ${today.getHours()}:${today.getMinutes()}`);
...
const readableDateFormat = today.toDateString();

const readableLocaleDateFormat = today.toLocaleDateString('nl-NL', {
    weekday: "short",
    year: "numeric",
    month: "short",
    day: "numeric",
...
console.log(readableDateFormat);
console.log(readableLocaleDateFormat);